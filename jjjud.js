(function($){
	$.JJJud = function(el, options){
        ...
        if(typeof _this.$el.attr('data-text') !== typeof undefined && _this.$el.attr('data-text') !== false){

        }else{
			_this.$el.attr("title",_this.$el.html().trim());
        	_this.$el.attr('data-text',_this.$el.html());
        }
